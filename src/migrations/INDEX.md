...
| `0012_mandatory_risk_envelope` | 0.73.0-beta | 2026-07-12 | accounts.json | Materialize fail-closed null Risk Envelopes for existing accounts without granting autonomy |
| `0013_codex_provider_override_marker` | 0.73.0-beta | 2026-07-15 | workspaces/<id>/.codex/config.toml, workspaces/<id>/.codex/env.json, workspaces/<id>/.alice/codex-provider-override.marker | Backfill .alice/codex-provider-override.marker for workspaces with a proven legacy codex provider override (issue #230). |
